...
public class CustomEntity extends SuperEntity {
    ...
    public CustomEntity(String orderId, String customerId, String customerName, double orderTotal, LocalDate orderDate) {
    ...
    public CustomEntity(String orderId, String customerId, int orderDetailsCount) {
